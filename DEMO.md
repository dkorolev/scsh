...
command -v packdiff >/dev/null 2>&1 \
  ...
  || echo "packdiff: not found (optional) — install with \`cargo install packdiff\` (0.3.6) to see per-step commit diffs"
